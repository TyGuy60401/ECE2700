...
HD_PWD='C:/Users/tydav/gitLocals/ECE2700/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_add_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_add_4.tcl -notrace
