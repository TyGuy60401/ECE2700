...
HD_PWD='C:/Users/tydav/gitLocals/ECE2700/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_add_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_add_4.tcl
